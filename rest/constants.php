<?php
define('CONST_APP_NAME', 'ThisHabbo');
define('CONST_APP_ENV', 'local');
define('CONST_APP_KEY', 'base64:FgYQAkO319B5M7ug+h9kPfzMpGtbXXGgM2fVs5FihiM=');
define('CONST_APP_DEBUG', 'true');
define('CONST_APP_URL', 'http://localhost:4200');
...
define(
    'CONST_PAYPAL_CLIENT_ID',
    'AY93kR0Gr1VxHYUKW47FNfu1dwMjwgOQ5oKjLlM8Iiwkku8UvgOqJ9sj0C7jrzjiIL1vRdbzqmoMHxKW'
);
define(
    'CONST_PAYPAL_SECRET',
    'EAcCmr13_6usxNHsWD2Ejf1VVohheUbr0OdgQc0x1u4NGVUb4H2A1slM2ZrRoIvp7lpt8NDqU1txAQ6c'
);
