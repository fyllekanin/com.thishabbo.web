    ...
    public function run()
    {
        ...
        \DB::table('bbcodes')->insert(array (
            ...
            array (
                ...
                'replace' => '<div style="padding:8px 35px 8px 14px;margin-bottom:18px;background-color:#c66464;border:1px solid #FFFFFF;width:70%;margin:auto;color:#ffffff;"><div><strong>Administrator Message:</strong></div><div>$1</div></div>',
                'content' => '$1',
                'isEmoji' => 0,
                'isSystem' => 0,
                'createdAt' => 1547139924,
            ...
            array (
                ...
                'pattern' => '/\[ca\](.*?)\[\/ca\]/si',
                'replace' => '<div style="padding:8px 35px 8px 14px;margin-bottom:18px;background-color:#c66464;border:1px solid #FFFFFF;width:70%;margin:auto;color:#ffffff;"><div><strong>Community Administrator Message:</strong></div><div>$1</div></div>',
                'content' => '$1',
                'isEmoji' => 0,
                'isSystem' => 0,
                'createdAt' => 1547139924,
            ...
            array (
                ...
                'pattern' => '/\[mod\](.*?)\[\/mod\]/si',
                'replace' => '<div style="padding: 8px 35px 8px 14px; margin-bottom: 18px; background-color: #000000; border: 1px solid #FFFFFF; -webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px; width:70%; color: #fff; margin: auto;"><div><strong>Moderator Message: </strong></div><div>$1</div></div>',
                'content' => '$1',
                'isEmoji' => 0,
                'isSystem' => 0,
                'createdAt' => 1547139924,
            ...
            array (
                ...
                'pattern' => '/\[snr\](.*?)\[\/snr\]/si',
                'replace' => '<div style="padding: 8px 35px 8px 14px; margin-bottom: 18px; background-color: #8B40AA; border: 1px solid #FFFFFF; -webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px; width: 70%; margin: auto; color:white;"><div><strong>Senior Message:</strong></div><div>$1</div></div>',
                'content' => '$1',
                'isEmoji' => 0,
                'isSystem' => 0,
                'createdAt' => 1547139924,
