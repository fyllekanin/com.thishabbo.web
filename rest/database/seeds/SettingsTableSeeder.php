...
Hope you will have a fun time here and join our team! ',
            ...
            array (
                'settingId' => 7,
                'key' => 'navigation',
                'value' => '[{"children":[{"label":"Home Page","url":"\\/home"},{"isDivider":true},{"label":"History","url":"\\/"},{"label":"Staff Members","url":"\\/"},{"isDivider":true},{"label":"Habbo Imager","url":"\\/goodies\\/habbo-imager"},{"isDivider":true},{"label":"Contact Us","url":"\\/"},{"label":"Rules","url":"\\/page\\/rules","loginRequired":false,"isOnMobile":false,"icon":null,"isDivider":false}],"label":"TH","icon":"fas fa-home"},{"children":[{"label":"Quests Hub","url":"\\/"},{"isDivider":true},{"label":"Badge Guides","url":"\\/"},{"isDivider":true},{"label":"Badge Scanner","url":"\\/"},{"label":"Top 25 Collected","url":"\\/"},{"isDivider":true},{"label":"Apply","url":"\\/"}],"label":"Quests","icon":"fa fa-book"},{"children":[{"label":"Around the World","url":"\\/"},{"isDivider":true},{"label":"Entertainment & Lifestyle","url":"\\/"},{"label":"Happy Hour","url":"\\/"},{"label":"Columns Corner","url":"\\/"},{"label":"In the Community","url":"\\/"},{"label":"Debates Corner","url":"\\/"},{"isDivider":true},{"label":"Apply","url":"\\/"}],"label":"Media","icon":"fas fa-newspaper"},{"children":[{"label":"Activity Hub","url":"\\/"},{"isDivider":true},{"label":"Quests","url":"\\/"},{"isDivider":true},{"label":"Rewards","url":"\\/"}],"label":"Activity","icon":"fas fa-users"},{"children":[{"label":"THC Hub","url":"\\/"},{"isDivider":true},{"label":"Betting Hub","url":"\\/betting\\/dashboard"},{"label":"Arcade","url":"\\/arcade"}],"label":"Games","icon":"fas fa-ticket-alt"},{"children":[{"label":"Clan Hub","url":"\\/"},{"isDivider":true},{"label":"Clan Leaderboard","url":"\\/"},{"isDivider":true},{"label":"Create a Clan","url":"\\/"}],"label":"Clans","icon":"fas fa-shield-alt"},{"children":[{"label":"Latest Posts","url":"\\/forum\\/latest-posts\\/page\\/1"},{"label":"Latest Threads","url":"\\/forum\\/latest-threads\\/page\\/1"},{"isDivider":true},{"label":"Shop","url":"\\/"},{"isDivider":true},{"label":"Public Groups","url":"\\/"}],"label":"Forum","icon":"far fa-comment-alt","url":"\\/forum"},{"children":[{"label":"Recruitment Hub","url":"\\/"},{"isDivider":true},{"label":"Apply","url":"\\/"}],"label":"Jobs","icon":"fas fa-bookmark"},{"children":[],"label":"Logout","icon":"fas fa-sign-out-alt","loginRequired":true,"isLogout":true,"isOnMobile":true}]',
                'createdAt' => 1549751879,
                'updatedAt' => 1551198889,
            ),
            7 =>
            array (
                'settingId' => 8,
