(function () {
    ...
    var defaultOptions = {
        ...
        toolbar: 'bold,italic,underline,strike,subscript,superscript|' +
            ...
            'horizontalrule,image,link,unlink|' +
    ...
    var _templates = {
        html:
            ...
            'body { min-height: 8.5rem; color: #7d7d7d; font-size: 0.7rem; font-family: \'Verdana\', sans-serif !important; }' +
            '.mention-user{ color:#85c7ff; }' +
            '.mention-group{ color:#5592c5; }' +
            'img { max-width: 100%; }' +
            '.quotepost { padding: 1rem; background-color: rgba(255, 255, 255, 0.32);' +
            'box-shadow: inset 0 0 0 1px rgba(191, 191, 191, 0.18), inset 0 0 0 2px rgba(255, 255, 255, 0.39), 0 2px 0 0 rgba(167, 167, 167, 0.123); }' +
    ...
    function RangeHelper(win, d) {
        ...
        base.replaceKeyword = function (
            ...
            var outerText, match, matchPos, startIndex,
                ...
                maxKeyLen = longestKeyword || ( keywords[keywordIdx - 1] ? keywords[keywordIdx - 1][0].length : 0);
                ...
                if (requireWhitespace) {
                    match = outerText
                        ...
                        .match(new RegExp(whitespaceRegex +
                            regex(keyword) + whitespaceRegex, 'i'));
