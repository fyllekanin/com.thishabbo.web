...
!function () {
    ...
    function Ke(e, t) {
        if (xe(t)) {
            var n = getComputedStyle(e), o = a(n.paddingLeft) + a(n.paddingRight),
    ...
    function Xe(e, t) {
        if (xe(t)) {
            var n = getComputedStyle(e), o = a(n.paddingTop) + a(n.paddingBottom),
    ...
    var n, p, m, ct = {
        ...
        }(), st = "-ms-ime-align" in document.documentElement.style, ut = /iPhone|iPod|iPad| wosbrowser\//i.test(g),
    ...
    var y = {
        html: '<!DOCTYPE html><html{attrs}><head><style>.ie * {min-height: auto !important} body { min-height: 8.5rem; color: #7d7d7d; font-size: 0.7rem; } img { max-width: 100%; } .ie table td {height:15px} @supports (-ms-ime-align:auto) { * { min-height: auto !important; } }</style><meta http-equiv="Content-Type" content="text/html;charset={charset}" /></head><body contenteditable="true" {spellcheck}><p></p></body></html>',
    ...
    var gt = {
        ...
        left: {
            state: function (e) {
                if (e && 3 === e.nodeType && (e = e.parentNode), e) {
                    var t = "ltr" === Pe(e, "direction"), n = Pe(e, "textAlign");
        ...
        link: {
            _dropDown: function (t, e, n) {
                var o = De("div");
                Fe(o, mt("link", {url: t._("URL:"), desc: t._("Description (optional):"), ins: t._("Insert")}, !0));
                var r = He(o, "#link")[0];
        ...
        emoticon: {
            exec: function (f) {
                var p = this, m = function (e) {
                    var t, n, o = p.opts, r = o.emoticonsRoot || "", i = o.emoticonsCompat, a = p.getRangeHelper(),
                        l = i && " " !== a.getOuterText(!0, 1) ? " " : "",
                        c = i && " " !== a.getOuterText(!1, 1) ? " " : "", s = De("div"), u = De("div"),
                    ...
                    }), !e && o.emoticons.more && (Fe(t = De("a", {className: "sceditor-more"}), document.createTextNode(p._("More"))), ze(t, "click", function (e) {
        ...
        youtube: {
            _dropDown: function (i, e, a) {
                ...
                Fe(l, mt("youtubeMenu", {
                    ...
                    var t = He(l, "#link")[0].value, n = t.match(/(?:v=|v\/|embed\/|youtu.be\/)(.{11})/),
    ...
    function vt(i, e) {
        var a, l, c = e || i.contentDocument || i.document, s = "sceditor-start-marker", u = "sceditor-end-marker",
            y = this;
        y.insertHTML = function (e, t) {
            ...
            var n = l(e, t), o = y.selectedRange(), r = o.commonAncestorContainer;
            if (!n) return !1;
    ...
    var yt = window, bt = document, xt = h, wt = xt && xt < 11, Ct = /^image\/(p?jpe?g|gif|png|bmp)$/i;

    function kt(l, e) {
        var a, w, u, c, i, m, d, s, f, p, g, h, t, v, r, y, b, x, C, n, o, k, S, E, T, D, M, N, R, F, H, _, z, O, A, B,
            I, L, P, V, W, j, q, U, $, Y, K, X, G, J, Q, Z, ee, te, ne, oe, re, ie, ae, le, ce, se, ue, de = this,
            fe = {}, pe = [], me = [], ge = {}, he = {}, ve = {};
        de.commands = Ce(!0, {}, e.commands || gt);
        var ye = de.opts = Ce(!0, {}, ct, e);
        de.opts.emoticons = e.emoticons || ct.emoticons, M = function () {
            l._sceditor = de, ye.locale && "en" !== ye.locale && z(), je(w = De("div", {className: "sceditor-container"}), l), Pe(w, "z-index", ye.zIndex), xt && Ue(w, "ie ie" + xt), n = l.required, l.required = !1;
            ...
            var e = l.form, t = "compositionstart compositionend", n = "keydown keyup keypress focus blur contextmenu",
            ...
            u = De("div", {
                ...
                i = De("div", {className: "sceditor-group"}), Se(t.split(","), function (e, t) {
                    var n, o, r = a[t];
                    if (r && !(-1 < l.indexOf(t))) {
                        ...
                        n._sceTxtMode = !!r.txtExec, n._sceWysiwygMode = !!r.exec, Ye(n, "disabled", !r.exec), ze(n, "click", function (e) {
                            ...
                            name: t,
                            state: r.state
                        }) : be(r.exec) && me.push({name: t, state: r.exec}), Fe(i, n), he[t] = n
                    }
                }), i.firstChild && Fe(u, i)
            }), Fe(ye.toolbarContainer || w, u)
        }, I = function () {
            var o, r, i, a, t, n, e = De("div", {className: "sceditor-grip"}),
                l = De("div", {className: "sceditor-resize-cover"}), c = "touchmove mousemove",
                s = "touchcancel touchend mouseup", u = 0, d = 0, f = 0, p = 0, m = 0, g = 0, h = Ke(w), v = Xe(w),
                y = !1, b = de.rtl();
            ...
            }, ye.dropDownCss), Pe(f = De("div", {className: "sceditor-dropdown " + i}), r), Fe(f, n), Fe(w, f), ze(f, "click focusin", function (e) {
                e.stopPropagation()
            }), setTimeout(function () {
                if (f) {
            ...
            var n, o, r = s.selectionStart, i = s.selectionEnd;
            ...
            ye.emoticonsEnabled && (e = m, s = ve, u = ye.emoticonsCompat, d = e.ownerDocument, t = "(^|\\s| | | | |$)", f = [], p = {}, Me(e, "code") || (Se(s, function (e) {
                ...
                for (t = t.firstChild; t;) {
                    if (t.nodeType !== Ee || We(t, "code") || e(t), t.nodeType === Te) for (var n = 0; n < f.length; n++) {
                        ...
                        if (-1 < i) {
                            var a = o.indexOf(r, i), l = et(s[r], d), c = o.substr(a + r.length);
            ...
            y !== t && (e = y, y = t, b = v.getFirstBlockParent(t), Ge(w, "nodechanged", {oldNode: e, newNode: y}))
            ...
            if (de.readOnly()) Se(He(u, n), function (e, t) {
                ...
                for (var i = 0; i < me.length; i++) {
                    var a = 0, l = he[me[i].name], c = me[i].state, s = r && !l._sceTxtMode || !r && !l._sceWysiwygMode;
                    if (be(c)) {
                        if (!r) try {
            ...
            !function (e, t) {
                ...
                if (e && o.length) for (var r = 0; r < o.length; r++) {
                    var i = o[r], a = i.parentNode, l = i.previousSibling, c = i.nextSibling;
                    if (l && n.test(l.nodeValue.slice(-1)) || c && n.test((c.nodeValue || "")[0])) {
                        var s = t.cloneSelected(), u = -1, d = s.startContainer, f = l.nodeValue;
            ...
            (ye.emoticonsEnabled = e) ? (ze(m, "keypress", oe), de.sourceMode() || (v.saveRange(), N(), ae(!1), v.restoreRange())) : (Se(He(m, "img[data-sceditor-emoticon]"), function (e, t) {
                var n = Ve(t, "sceditor-emoticon"), o = d.createTextNode(n);
                t.parentNode.replaceChild(o, t)
            }), Oe(m, "keypress", oe), ae());
            return de
        }, de.css = function (e) {
            return o || (o = De("style", {id: "inline"}, d), Fe(d.head, o)), be(e) ? (o.styleSheet ? o.styleSheet.cssText = e : o.innerHTML = e, de) : o.styleSheet ? o.styleSheet.cssText : o.innerHTML
        }, W = function (e) {
            var t = [], n = {
                "`": "~",
                1: "!",
            ...
            if (r && (r.hasHandler("valuechangedEvent") || ae.hasHandler)) {
                ...
                e = (g = !1) !== e && !d.getElementById("sceditor-start-marker"), h && (clearTimeout(h), h = !1), o && e && v.saveRange(), (t = n ? s.value : m.innerHTML) !== ae.lastVal && (ae.lastVal = t, Ge(w, "valuechanged", {rawValue: n ? de.val() : t})), o && e && v.removeMarkers()
            }
        }, le = function () {
            h && ae()
        }, ce = function (e) {
            var t = e.which, n = ce.lastChar, o = 13 === n || 32 === n, r = 8 === n || 46 === n;
