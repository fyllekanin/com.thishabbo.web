...
describe('AutoSaveHelper', () => {
    ...
    describe('exists', () => {
        it('should return true if the type and contentId exists in localStorage', () => {
            // Given
    ...
    it('save should save the content to localStorage', () => {
        // When
    ...
    it('remove should delete the item from localStorage', () => {
        // Given
        AutoSaveHelper.save({ type: AutoSave.THREAD, contentId: 1, content: 'test' });
