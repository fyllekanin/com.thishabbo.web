...
export class EssentialsComponent extends Page implements OnDestroy {
    ...
    onRemoveAvatar (): void {
        this._httpService.delete(`sitecp/users/${this._data.userId}/avatar`)
            .subscribe(() => {
    ...
    onRemoveCoverPhoto (): void {
        this._httpService.delete(`sitecp/users/${this._data.userId}/cover-photo`)
            .subscribe(() => {
    ...
    onRemoveSignature (): void {
        this._httpService.delete(`sitecp/users/${this._data.userId}/signature`)
            .subscribe(() => {
