...
@Component({
    selector: 'app-admin-shop-subscriptions-list',
...
export class SubscriptionsListComponent extends Page implements OnDestroy {
    ...
    tabs: Array<TitleTab> = [
        new TitleTab({title: 'Create New', link: '/admin/shop/subscriptions/new'})
    ];
    ...
    onAction (action: Action): void {
        switch (action.value) {
            case SubscriptionListAction.EDIT:
                this._router.navigateByUrl(`/admin/shop/subscriptions/${action.rowId}`);
                break;
    ...
    private onData (data: { data: SubscriptionsListPage }): void {
        ...
        this.pagination = new PaginationModel({
            ...
            url: '/admin/shop/subscriptions/page/:page',
            params: this._filter
        });
    }
