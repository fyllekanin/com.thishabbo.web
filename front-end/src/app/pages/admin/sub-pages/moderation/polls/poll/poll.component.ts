...
import { SITECP_BREADCRUMB_ITEM, POLL_LIST_BREADCRUMB_ITEM } from '../../../../admin.constants';
import { BreadcrumbService } from 'core/services/breadcrum/breadcrumb.service';

@Component({
    selector: 'app-admin-moderation-poll',
...
export class PollComponent extends Page implements OnDestroy {
    ...
    onBack(): void {
        this._router.navigateByUrl('/admin/moderation/polls/page/1');
    }
